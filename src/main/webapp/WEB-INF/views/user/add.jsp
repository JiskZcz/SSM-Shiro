                ...
                <div class="panel-body">
                    <form role="form" id="insertUser">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userpassword" placeholder="请输入用户密码">
                        </div>
                        <div class="form-group">
    ...
    $(function () {
        ...
        $("#insertBtn").click(function(){
            ...
            $.ajax({
                ...
                data : $("#insertUser").serialize(), //input属性 一定要是name 不能使用id，否者系列化内容为空。
                beforeSend : function() {
                ...
                success : function(result) {
                    ...
                    if ( result.code == 100 ) {
                        ...
                        if (undefined == result.extend.usernameisnotunique) {
