                ...
                <ul style="padding-left:0px;" class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            ...
                            <li style="height:30px;">
                                <a href="./index"><i class="glyphicon glyphicon-king"></i> 角色维护</a>
                            </li>
                            <li style="height:30px;">
                    ...
                    <form class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input id="queryText" class="form-control has-success" type="text" placeholder="请输入部门名查询">
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success : function(result) {
                ...
                if ( result.code==100 ) {
                    ...
                    var tableContent = "";
                    var pageContent = "";
                    var rolePage = result.extend.pageInfo;
                    ...
                    $.each(roles, function(i, role){
                        ...
                        tableContent += '	  <button type="button" onclick="deleteRole('+role.id+', \''+role.name+'\','+pn+')" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
                        tableContent += '  </td>';
                        tableContent += '</tr>';
                    });
                    ...
                    if ( pn < rolePage.pages ) {
                        pageContent += '<li><a href="#" onclick="pageQuery('+(pn+1)+')">下一页</a></li>';
                        pageContent += '<li><a href="#" onclick="pageQuery('+(rolePage.pages)+')">末页</a></li>';
                    }
    ...
    function deleteRoles() {
        ...
        if ( boxes.length == 0 ) {
            ...
            layer.confirm("删除选择的用户信息, 是否继续",  {icon: 3, title:'提示'}, function(cindex){
                // 删除选择的用户信息
                console.info($("#roleForm").serialize());
                $.ajax({
                    type : "DELETE",
