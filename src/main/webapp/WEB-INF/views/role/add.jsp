    ...
    $(function () {
        ...
        $("#insertBtn").click(function(){
            ...
            $.ajax({
                ...
                data : $("#insertRole").serialize(), //input属性 一定要是name 不能使用id，否者系列化内容为空。
                beforeSend : function() {
                ...
                success : function(result) {
                    ...
                    if ( result.code == 100 ) {
                        layer.msg("部门信息保存成功", {time:1000, icon:6}, function(){
                            window.location.href = "${APP_PATH}/role/index";
                        });
                    } else {
                        layer.msg("相关部门已存在", {time: 2000, icon: 5, shift: 6}, function () {
