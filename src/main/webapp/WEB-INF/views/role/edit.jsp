                ...
                <ul style="padding-left:0px;" class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            ...
                            <li style="height:30px;">
                                <a href="./index"><i class="glyphicon glyphicon-certificate"></i> 角色维护</a>
                            </li>
                            <li style="height:30px;">
                ...
                <div class="panel-body">
                    <form id="roleForm" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="${role.name}" placeholder="请输入部门名称">
                        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#updateBtn").click(function(){
            var name = $("#name").val();
            if ( name == "" ) {
                layer.msg("部门名不能为空，请输入", {time:2000, icon:5, shift:6}, function(){
            ...
            $.ajax({
                ...
                success : function(result) {
                    ...
                    if ( result.code==100) {
                        layer.msg("部门信息修改成功", {time:1000, icon:6}, function(){
                            window.location.href = "${APP_PATH}/role/index";
                        });
                    } else {
                        if (undefined != result.extend.errorMsg) {

                            layer.msg("已存在相关部门", {time: 2000, icon: 5, shift: 6}, function () {
